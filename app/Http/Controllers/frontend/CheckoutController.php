...
class CheckoutController extends Controller
{
  public function index()
  {
    ...
    // error_log('$old_cartitem' . $old_cartitem);
  ...
  public function placeOrder(Request $request)
  {
    ...
    error_log('$cartitems_total' . $cartitems_total);
    foreach ($cartitems_total as $prod) {
      error_log('$prod->products->selling_price' . $prod->products->selling_price);
    ...
    $order->tracking_no = 'Ayoub&Amina' . rand(1111, 9999);
    $order->save();
