<nav class="navbar navbar-expand-lg navbar-default navbar-dark fixed-top bg-white">
  <div class="container-fluid  navbar-default ">
    <a class="navbar-brand" href="{{url('/')}}">Bazaary</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      ...
      <div class="navbar-nav ms-auto justify-content-center">
        ...
        <div class="input-group hello">
          <form class="d-flex bg-transparent w-100" action="{{url('searchProduct')}}" class="form-control"
            method="POST">
            @csrf
            <div class="input-group">
              <input name="product_name" required type="search" id="search_product"
                class="form-control rounded-pill outline-none " placeholder="Search..."
        ...
        <li class="nav-item dropdown">
          <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
            ...
            <img src="https://cdn-icons-png.flaticon.com/512/6596/6596121.png" class="rounded-circle" height="22"
