          ...
          <div class="card-body">
            ...
            <div class="row checkout-form">
              ...
              <div class="col-md-6  my-2">
                ...
                <input type="text" name="lname" class="form-control" value="{{Auth::user()->name}}"
                  placeholder="First Name" required>
              </div>
              <div class="col-md-6  my-2">
              ...
              <div class="col-md-6  my-2">
                ...
                <input type="number" name="phoneno" class="form-control" value="{{Auth::user()->phoneno}}"
                  placeholder="0622113344" required>
              </div>
              <div class="col-md-6  my-2">
              ...
              <div class="col-md-6  my-2">
                ...
                <input type="text" name="state" class="form-control" value="{{Auth::user()->state}}"
                  placeholder="Casablanca-Settat" required>
              </div>
              <div class="col-md-6  my-2">
                <label for="email">Country</label>
                <input type="text" name="country" class="form-control" value="{{Auth::user()->country}}"
                  placeholder="Morocco" required>
              </div>
              <div class="col-md-6  my-2">
                <label for="email">Zip Code</label>
                <input type="number" name="pincode" class="form-control" value="{{Auth::user()->pincode}}"
