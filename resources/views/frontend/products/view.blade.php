    ...
    <div class="card-body">
      <div class="row">
        ...
        <div class="col-md-8">
          <h2 class="mb-0">
            {{$product->name}}
            <label for="" style="font-size: 1rem; background:black; color:white;"
              class="float-end badge  trending_tag">{{$product->trending == "1" ? 'Trending': '' }}</label>
          </h2>
          <hr>
          <label for="" class="me-3">Original Price : <s>MAD {{$product->original_price}}</s></label>
          <label for="" class="fw-bold">Selling Price : MAD {{$product->selling_price}}</label>
          <p class="mt-3">
            {!! $product->small_description !!}
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Numquam labore quibusdam voluptate repudiandae
            accusamus dicta aut voluptates doloremque perspiciatis beatae!
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Sapiente incidunt ducimus culpa vita
          </p>
          <hr>
          @if($product->qty > 0)
          <label for="" style="background:black; color:white;" class="badge">In Stock</label>
          @else
          ...
          <div class="row mt-2">
            <div class="col-md-2">
              ...
              <div class="input-group text-center mb-3">
                ...
                <input type="text" readonly name="quantity" value="1"
                  class="form-control quantity-input bg-light text-center">
            ...
            <div class="col-md-10">
              <br />
              @if($product->qty > 0)
              <button class="btn btn-outline-primary me-3 float-start addToCartButton">Add to Cart <i
